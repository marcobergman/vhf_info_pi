...
#ifndef _VHFINFOPI_H_
#define _VHFINFOPI_H_
...
#define OPC wxS("opencpn-vhf_info_pi")
...
class vhf_info_pi : public wxEvtHandler, public opencpn_plugin_116
{
    friend ConsoleCanvas;
public:

    vhf_info_pi(void *ppimgr);
