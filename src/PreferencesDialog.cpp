...
bool PreferencesDialog::Show( bool show )
{
    if(show) {
        ...
        // load preferences
        vhf_info_pi::preferences &p = m_pi.prefs;
        ...
        m_cComputation->SetSelection(p.computation == vhf_info_pi::preferences::MERCATOR);
...
{
    wxLaunchDefaultBrowser(_T("http://www.github.com/seandepagnier/vhf_info_pi"));
}
...
void PreferencesDialog::OnOk( wxCommandEvent& event )
{
    ...
    p.route_position_bearing_mode = (vhf_info_pi::preferences::RoutePositionBearingMode)
    ...
    p.computation = (vhf_info_pi::preferences::ComputationType)m_cComputation->GetSelection();
